...
if (!$section)
{
	...
	<tr>
		...
		<tr>
			...
			|-werden gel�scht: $player['nrdel']l]."<br>
			|-&Oslash; Sympathie: ".$player['symp']."<br>
			|-F�deration: $player['fed']d]."<br>
		...
		<tr>
			...
			|-Tr�mmerfelder: $ships['trums']s]."<br></td>
		</tr>
		</table>
		</td>
		<td width=150 valign=top>
	...
	<tr>
		...
		<tr>
			<td class=tdmainobg>
			<a href=main.php?page=stats&section=bestcols>Die 10 gr��ten Kolonien</a><br>
			<a href=main.php?page=stats&section=bestfleet>Die 10 gr��ten Flotten</a><br>
			<a href=main.php?page=stats&section=bestweap>Die 10 bestbewaffnetsten Flotten</a><br>
			<a href=main.php?page=stats&section=bestwirt>Die 10 st�rksten Wirtschaftsm�chte</a><br>
			<a href=main.php?page=stats&section=mostbev>Die 10 bev�lkerungsreichsten Kolonisten</a><br>
		...
		<tr>
			<td class=tdmainobg><a href=main.php?page=hally&section=goodview>Waren�bersicht</a></td>
		</tr></table>
		</td><td valign=top>
		<table cellpadding=1 cellspacing=1 bgcolor=#262323>
		<tr>
		...
		<tr>
			...
			<a href=main.php?page=stats&section=buildclasses>Details: Geb�ude</a><br>
		...
		<tr>
			...
			Bev�lkerung: ".$bev." (".($myDB->query("SELECT COUNT(user_id) FROM stu_stats WHERE bev>".$bev,1)+1).".)</td>
		</tr>
		</table>
		</td>
	</tr>
...
elseif ($section == "bestcols")
{
	...
	echo "<table width=100% bgcolor=#262323 cellspacing=1 cellpadding=1>
	<tr>
		<td class=tdmain>/ <a href=?page=stats>Statistiken</a> / <strong>Die 10 gr��ten Kolonien</strong></td>
	</tr>
	</table><br><br>
...
elseif ($section == "mostbev")
{
	...
	echo "<table width=100% bgcolor=#262323 cellspacing=1 cellpadding=1>
	<tr>
		<td class=tdmain>/ <a href=?page=stats>Statistiken</a> / <strong>Die 10 bev�lkerungsreichsten Kolonisten</strong></td>
	</tr>
	</table><br>
	<table width=50% cellpadding=1 cellspacing=1 bgcolor=#262323>
	<tr>
		<td class=tdmainobg><strong>User</strong></td>
		<td class=tdmainobg><strong>Bev�lkerung</strong></td>
	</tr>";
	for ($i=0;$i<count($cols);$i++)
	{
		echo "<tr>
...
elseif ($section == "bestfleet")
{
	...
	echo "<table width=100% bgcolor=#262323 cellspacing=1 cellpadding=1>
	<tr>
		<td class=tdmain>/ <a href=?page=stats>Statistiken</a> / <strong>Die 10 gr��ten Flotten</strong></td>
	</tr>
	</table><br>
	<table width=70% cellpadding=1 cellspacing=1 bgcolor=#262323>
	<tr>
	...
	if ($cols == 0)	echo "<tr><td class=tdmainobg colspan=2 align=Center>F�r diese Runde sind keine Daten gespeichert</td></tr>";
	else
	{
		for ($i=0;$i<count($cols);$i++) {
			echo "<tr>
...
elseif ($section == "bestwirt")
{
	...
	echo "<table width=100% bgcolor=#262323 cellspacing=1 cellpadding=1>
	<tr>
		<td class=tdmain>/ <a href=?page=stats>Statistiken</a> / <strong>Die 10 gr��ten Wirtschaftsm�chte</strong></td>
	</tr>
	</table><br>
	<table width=50% cellpadding=1 cellspacing=1 bgcolor=#262323>
	<tr>
