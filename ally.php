...
if ($section == "overview") {
	...
	if ($myUser->ually == 0) echo "<table cellpadding=1 cellspacing=1 bgcolor=#262323><tr><td class=tdmain><strong>Meldung</strong></td></tr><tr><td class=tdmainobg><a href=main.php?page=ally&section=newally>Allianz gr�nden</a></td></tr></table><br>";
	echo "<table cellpadding=1 cellspacing=1 bgcolor=#262323>
	<tr>
		<td class=tdmainobg><strong>Name</strong></td>
		<td class=tdmainobg><strong>Pr�sident</strong></td>
	...
	<tr>
		...
		<table cellpadding=1 cellspacing=1 bgcolor=#262323 width=100%>
			<tr>
				<td class=tdmainobg width=30%>Pr�sident</td>
				<td class=tdmainobg>" . stripslashes($myUser->getfield("user", $ally['user_id'])) . "</td>
			</tr>
			<tr>
				<td class=tdmainobg>Vize-Pr�sident</td>
				<td class=tdmainobg>" . $vize . "</td>
			</tr>
			<tr>
				<td class=tdmainobg>Au�enminister</td>
	...
	<tr>
		<td class=tdmainobg width=80>Pr�sident</td>
	...
	echo "</tr>
	<tr>
		<td class=tdmainobg>Au�enminister/Diplomatie</td>";
	...
	echo "<table width=100% bgcolor=#262323 cellspacing=1 cellpadding=1>
	<tr>
		<td width=100% class=tdmain>/ Allianzschirm / <a href=?page=ally&section=overview>Allianzliste</a> / <strong>Allianz gr�nden</strong></td>
	</tr>
	</table><br>";
	if ($result) echo "<table width=300 bgcolor=#262323 cellspacing=1 cellpadding=1><tr><td class=tdmain><strong>Meldung</strong></td></tr><tr><td class=tdmainobg>" . $result['msg'] . "</td></tr></table><br>";
	...
	<tr>
		<td class=tdmainobg align=center><input class=button type=submit value='Allianz gr�nden'></td>
	</tr></form>
	</table>";
	...
	if ($confirm == 0) {
		...
		<tr>
		<td class=tdmainobg>";
		$ally['user_id'] == $user ? print("Du bist der Pr�sident der Allianz.<br>Wenn Du die Allianz verl�sst wird die F�hrung den Vizepr�sidenten abgegben oder gel�scht. Willst Du das wirklich?<br><a href=main.php?page=ally&section=leaveally&id=" . $id . "&confirm=1><font color=red>Best�tigung</font></a>") : print("Willst Du die Allianz wirklich verlassen?<br><a href=main.php?page=ally&section=leaveally&id=" . $id . "&confirm=1><font color=red>Best�tigung</font></a>");
		echo "</td></tr></table><br>";
	}
	...
	<tr>
		<td class=tdmainobg>";
	$id && $confirm == 0 ? print("Willst Du das Mitglied wirklich rausschmeissen?<br><a href=main.php?page=ally&section=delfromally&id=" . $id . "&confirm=1>Best�tigung</a>") : print("Mitglied entfernt");
	echo "</td></tr></table>";
	...
	if ($bez == 0) echo "<tr><td class=tdmainobg colspan=4 align=center>Keine Beziehungen vorhanden</td></tr>";
		...
		for ($i = 0; $i < count($bez); $i++) {
			...
			if ($bez[$i]['type'] == 4) $type = "<font color=#ffffff>B�ndnis</font>";
			...
			if ($bez[$i]['type'] != 1) {
				echo "<option value=1>Krieg</option>
					...
					<option value=4>B�ndnis</option>
					<option value=5>L�schen</option>";
			} else {
				echo "<option value=6>Frieden</option>";
			}
			echo "</select> <input type=submit value=�ndern class=button></td></tr></form>";
		}
	}
	...
	<tr>
		<td width=100% class=tdmainobg><strong>Beziehung �ndern/erstellen</strong></td>
	</tr>
	<form action=main.php method=post>
	<input type=hidden name=page value=ally>
	<input type=hidden name=section value=diplo>
	...
	echo "<tr>
		<td class=tdmainobg align=center><input type=submit class=button value='Einstellungen �ndern'></td>
	</tr></form>
	</table><br>
	...
	<tr>
		<td class=tdmainobg>Vizepr�sident</td>
	...
	<input type=hidden name=id value=" . $data['id'] . ">
	<tr>
		<td class=tdmainobg colspan=3>Neuer Vizepr�sident - User-ID: <input type=text size=5 name=new_vize class=text> <input type=submit value=Ernennen class=button></td>
	</tr>
	</form>";
	...
	<input type=hidden name=id value=" . $data['id'] . ">
	<tr>
		<td class=tdmainobg colspan=3>Neuer Au�enminister - User-ID: <input type=text size=5 name=new_diplo class=text> <input type=submit value=Ernennen class=button></td>
	</tr>
	</form>";
	if ($user == $data['user_id']) {
		...
		<input type=hidden name=id value=" . $data['id'] . ">
		<tr>
			<td class=tdmainobg colspan=3><font color=#FF0000>Pr�sidentschaft abgeben</font> - User-ID: <input type=text size=5 name=new_presi class=text> <input type=submit value=Abgeben class=button></td>
		</tr>
		</form>";
	}
	echo "</table><br>
	<table width=100% cellpadding=1 cellspacing=1 bgcolor=#262323>
	<tr>
		<td class=tdmain align=center><a href=main.php?page=ally>�bersicht</a> - <a href=http://stu.weers-online.net/main.php?page=ally&section=overview>Allianzliste</a></td>
	</tr>
	</table>";
	...
	echo "<table width=100% bgcolor=#262323 cellspacing=1 cellpadding=1>
	<tr>
		<td width=100% class=tdmain>/ Allianzschirm / <a href=?page=ally>" . $data['name'] . "</a> / <a href=main.php?page=ally&section=botschaften&id=" . $data['id'] . ">Botschaften</a> / <strong>Baustil ver�ndern</strong></td>
	</tr>
	</table><br>";
	if ($result != 0) {
		echo "<table cellpadding=1 cellspacing=1 bgcolor=#262323><tr><td class=tdmain><strong>Meldung</strong></td></tr><tr><td class=tdmainobg>";
	...
	echo "<br><img src=" . $grafik . "/buildings/" . $type['build']['id'] . "_1.gif> Gew�hlter Baustil<br>";
	...
	echo "<br><a href=main.php?page=ally&section=botschaftenstyle&id=" . $data['id'] . "&embassy=" . $embassy . "&style=211&action=1><img src=" . $grafik . "/buildings/211_1.gif border=0> F�deration";
	...
	echo "<table width=100% align=Center cellspacing=1 cellpadding=1 bgcolor=#262323>
		...
		<tr>
			<td class=tdmain>Allianz ausw�hlen <select name=aid>";
	...
	if ($aid) {
		...
		if ($bez == 0) echo "<td class=tdmainobg align=center>Keine Beziehungen vorhanden</td>";
			...
			while ($bd = mysql_fetch_assoc($bez)) {
				...
				if ($bd['type'] == 4) $b = "<font color=#ffffff>B�ndnis</font>";
