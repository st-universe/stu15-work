<table width=100%>
	...
	<tr>
		<td class=tdmain align=center>
			<form action=index.php method=post><input type=hidden name=page value=player>ID <input type=text class=text size=5 name=id> <input type=submit class=button value=Suche></form>
		</td>
		<td></td>
		<td class=tdmain align=center>
			<form action=index.php method=post><input type=hidden name=page value=ship>ID <input type=text class=text size=5 name=id> <input type=submit class=button value=Suche></form>
		</td>
		<td></td>
		<td class=tdmain align=center>
			<form action=index.php method=post><input type=hidden name=page value=colony> <input type=hidden name=section value=showcolony>ID <input type=text class=text size=5 name=id> <input type=submit class=button value=Suche></form>
		</td>
	</tr>
</table>
<br>
