...
if (!$section || ($section == "main")) {
	...
	<tr>
		<td class=tdmain colspan=5 align=center>Bev�lkerungsanzeige MkII<br>
		<form action="index.php" method=post>
		<input type=hidden name=page value=colony>
	...
	if ($data == 0) echo "Kolonie nicht vorhanden";
		...
		<tr>
			<td class=tdmainobg>Bev�lkerung: "$data['bev_used']d] $data['bev_used']e])."/$data['bev_used']v]." (".$bev_add_show.")</td>
		</tr>
		<tr>
			<td class=tdmainobg>";
