...
?>
	<table width=100%>
		...
		?>
		<?php echo "<tr><td class=tdmain align=center><form action=index.php method=post><input type=hidden name=page value=player><input type=hidden name=section value=rump>Cheatr�mpfe freigeben  <input type=submit value=Anzeigen></form></td></tr>";
		?>
	</table>
<?php
...
?>
	...
	<tr>
		...
		<td class=tdmain align=center><b>Kapazit�t</b></td>
