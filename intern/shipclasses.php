...
if (!$section || ($section == "overview")) {
	...
	<tr>
		<td class=tdmain colspan=7 align=center><a href=?page=shipclasses&section=addclass>Schiffsklasse einf�gen</a></td>
	</tr>";
	...
	<tr>
		<td class=tdmain>Phaserst�rke</td>
	...
	<tr>
		<td colspan=2 align=Center class=tdmain><input type=submit value=Editieren class=button> <input type=reset value=Zur�cksetzen class=button></td>
	</tr>
	</form>
	</table>";
	...
	<tr>
		<td class=tdmaintop colspan=5 align=center width=100%>Schiffsklasse hinzuf�gen</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
	...
	<tr>
		<td colspan=2 align=Center class=tdmain><input type=submit value=Hinzuf�gen class=button> <input type=reset value=Zur�cksetzen class=button></td>
	</tr>
	</form>
	</table>";
}
