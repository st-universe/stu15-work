...
if ($section == "ship")
{
	...
	else
	{
		...
		echo "<img src=".$grafik."/goods/".$mod['goods_id'].".gif border=0> H�lle: $mod['goods_id']e]."/$mod['goods_id']l];
		...
		echo "<br><img src=".$grafik."/buttons/t_torp".$torpclass."1.gif border=0 title='Torpedokapazit�t'> $class['torps']s];
		if ($class['probe_stor'] > 0) echo "<br><img src=".$grafik."/goods/35.gif title='Sondenkapazit�t'> $class['probe_stor']r];
		...
		if ($class['slots'] > 0) echo "<br><img src=".$grafik."/buttons/dock1.gif border=0> Dockpl�tze: $class['slots']s];
...
elseif ($section == "rump")
{
	...
	if ($class['slots'] > 0) echo "<br>Dockpl�tze: $class['slots']s];
