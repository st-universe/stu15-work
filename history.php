...
if (mysql_num_rows($result) == 0) echo "<tr><td colspan=2 class=tdmainobg align=center>Es wurden keine Geschehennisse gespeichert</td></tr>";
	...
	<tr>
		<td class=tdmainobg colspan=2>Die letzten <input type=text size=4 name=limit class=text value=30> Events der Kategorie <select name=cat><option value=0>alle<option value=1>Kampfmeldungen<option value=2>Selbstzerst�rung<option value=3>Diplomatie</select> <input type=submit value=anzeigen class=button></td>
	</tr>
	</form>";
