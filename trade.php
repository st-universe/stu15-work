...
if ($myUser->uhasperr == 1) {
	...
	<tr>
		<td width=100% class=tdmain>/ <strong>Warenb�rse</strong></td>
	</tr>
	</table><br>
...
if (!$section || ($section == "boerse")) {
	if (($action == "deloffer") && ($user == 5) && $userid && $id) {
		...
		$myComm->sendpm($userid, 5, "Ihr Angebot " . $id . " wurde aufgrund eines Regelversto�es gel�scht");
	}
	if (($action == "konfoffer") && ($user == 5) && $userid && $id) {
		$return = $myTrade->konfoffer($id, $userid);
		$myComm->sendpm($userid, 5, "Die Handelsallianz hat Ihr Angebot " . $id . " eingezogen, m�glicherweise wegen wiederholten Versto�es gegen die Handelsregeln.");
	}
	...
	echo "<table width=100% bgcolor=#262323 cellpadding=1 cellspacing=1>
	<tr>
		<td width=100% class=tdmain>/ <a href=?page=trade>Warenb�rse</a> / <strong>Angebote ansehen</strong></td>
	</tr>
	</table><br>";
	if ($return) echo "<table bgcolor=#262323 cellpadding=1 cellspacing=1><tr><td class=tdmain><strong>Meldung</strong></td></tr>
		<tr><td class=tdmainobg>" . $return['msg'] . "</td></tr></table><br>";
	...
	if (mysql_num_rows($result) != 0) {
		...
		while ($offers = mysql_fetch_assoc($result)) {
			...
			echo "<td class=tdmainobg>
					<a href=main.php?page=trade&section=showoffers&offerid=" . $offers['id'] . ">l�schen</a>
				</td></tr>";
		}
	}
	echo "</table>";
	...
	echo "<table width=100% bgcolor=#262323 cellpadding=1 cellspacing=1>
	<tr>
		<td width=100% class=tdmain>/ <a href=?page=trade>Warenb�rse</a> / <strong>Konto einsehen</strong></td>
	</tr>
	</table><br>";
	...
	if ($sent == 1) {
		if ($myTrade->offercount() >= 25) $msg = "Es sind nur 25 Angebote pro Siedler erlaubt";
			...
			} elseif ($error == 2) $msg = "Warenmenge �bersteigt handelbares Maximum";
			else $msg = "Angebot fehlerhaft";
		}
	}
	echo "<table width=100% bgcolor=#262323 cellpadding=1 cellspacing=1>
	<tr>
		<td width=100% class=tdmain>/ <a href=?page=trade>Warenb�rse</a> / <strong>Angebot erstellen</strong></td>
	</tr>
	</table><br>";
	if ($msg) echo "<table bgcolor=#262323 cellpadding=1 cellspacing=1><tr><td class=tdmain><strong>Meldung</strong></td></tr>
		<tr><td class=tdmainobg>" . $msg . "</td></tr></table><br>";
	...
	<tr>
		...
		<td class=tdmain><strong>H�chstmenge</strong></td>
	...
	echo "<table width=100% bgcolor=#262323 cellpadding=1 cellspacing=1>
	<tr>
		<td width=100% class=tdmain>/ <a href=?page=trade>Warenb�rse / <strong>Handelslogs</strong></a></td>
	</tr>
	</table><br>";
	echo "<table width=100% bgcolor=#262323 cellpadding=1 cellspacing=1>";
	...
	<tr>
		<td width=100% class=tdmain>/ <a href=?page=trade>Warenb�rse / <strong>Merchandising-Artikel</strong></a></td>
	</tr>
	</table><br>";
	...
	echo "Actionfiguren werden nun zum Verkauf angeboten. <br><br>Ein Paket kostet 25 Latinum, jedes Paket enth�lt eine zuf�llige, hochwertige Actionfigur.<br><br>Der komplette Satz umfasst zur Zeit: 22 Figuren, davon 3 seltene und 1 sehr seltene.<br><br><br>";

	echo "<table bgcolor=#262323 cellspacing=1 cellpadding=1 width=400><tr><td class=tdmain colspan=3>Actionfiguren</td></tr>
        <tr>
	<td class=tdmainobg width> 1x <img src=" . $grafik . "/buttons/info1.gif title='Zuf�llige Actionfigur'></td>
	...
	echo "<table width=100% bgcolor=#262323 cellpadding=1 cellspacing=1>
	<tr>
		<td width=100% class=tdmain>/ <a href=?page=trade>Warenb�rse / <strong>Userkonten</strong></a></td>
	</tr>
	</table><br>";
	echo "<table width=100% bgcolor=#262323 cellpadding=1 cellspacing=1>";
	$log = $myTrade->gettradelog();
