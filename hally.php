...
if (!$section) {
	...
	if ($myUser->ulevel < 8) echo "<a href=main.php?page=hally&section=getship>Schiff beantragen</a><br>
			<a href=main.php?page=hally&section=getlevel>H�heres Kolonistenlevel beantragen</a><br>";
	...
	echo "<a href=main.php?page=comm&section=writepm&recipient=5>Kontakt aufnehmen</a></td>
		...
		<tr>
			...
			<a href=main.php?page=hally&section=buildings>Geb�udetypen</a><br>
			<a href=main.php?page=hally&section=mapdb>Kartenfelder</a><br>
			<a href=main.php?page=hally&section=shipclassesdb>Schiffsr�mpfe</a><br>
	...
	<tr>
		<td class=tdmain>/ <a href=?page=hally>Handelsallianz</a> / <strong>Geb�udetypen</strong></td>
	</tr>
	</table>
	<br>
	<table width=400>";
	...
	while ($buildings = mysql_fetch_assoc($res)) {
		...
		if ($buildings['id'] != 39 && ($buildings['id'] <= 108 || $buildings['id'] >= 113) && ($buildings['id'] <= 115 || $buildings['id'] >= 120) && ($buildings['id'] <= 122 || $buildings['id'] >= 127) && ($buildings['id'] <= 129 || $buildings['id'] >= 134) && $buildings['id'] != 171 && $buildings['id'] != 172 && $buildings['id'] != 173 && $buildings['id'] != 174 && $buildings['id'] != 175 && $buildings['id'] != 197 && $buildings['id'] != 203 && $buildings['id'] != 206 && $buildings['id'] != 207) {
			...
			echo "<br><img src=" . $grafik . "/buttons/time.gif alt='Bauzeit'> " . $time . "<br><img src=" . $grafik . "/buttons/integ.gif alt='Integrit�t'> " . $buildings['integrity'] . "<br>";
			echo "<br>+/-<br>";
			...
			if ($buildings['eps_pro'] > 0) {
				if ($buildings['id'] == 80) echo "<img src=" . $grafik . "/buttons/e_trans2.gif>+ Abh�ngig von Gravitation<br>";
	...
	<tr>
		...
		<td class=tdmainobg width=30%>d�nner Nebel</td>
	...
	<tr>
		...
		<td class=tdmainobg width=65%>Bei Phasersch�ssen Gefahr durch explodierendes Metreongas</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class=tdmainobg width=30%>d�nnes Asteroidenfeld (Iridium-Erz)</td>
	...
	<tr>
		...
		<td class=tdmainobg width=30%>d�nnes Asteroidenfeld (Kelbonit-Erz)</td>
	...
	<tr>
		...
		<td class=tdmainobg width=30%>d�nnes Asteroidenfeld (Nitrium-Erz)</td>
		<td class=tdmainobg width=65%>-1 Energie beim Einflug, Vorkommen: 2</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class=tdmainobg width=65%>20% H�llenschaden beim Einflug</td>
	</tr>
	<tr>
		<td class=tdmainobg align=center width=5%><img src=" . $grafik . "/map/13.gif></td>
		<td class=tdmainobg width=30%>R�ntgenpulsar</td>
	...
	<tr>
		...
		<td class=tdmainobg width=65%>Durchflug m�glich, Kosten: 13 Energie</td>
	</tr>
	<tr>
		<td class=tdmainobg align=center width=5%><img src=" . $grafik . "/map/27.gif></td>
		<td class=tdmainobg width=30%>Borg-Tr�mmerg�rtel</td>
	...
	echo "<table width=100% cellpadding=1 cellspacing=1 bgcolor=#262323>
	<tr>
		<td class=tdmain>/ <a href=?page=hally>Handelsallianz</a> / <strong>Schiffsr�mpfe</strong></td>
	</tr>
	</table><br>
	<table width=100% cellpadding=1 cellspacing=1 bgcolor=#262323>";
	for ($i = 0; $i < count($ships); $i++) {
		if (($ships[$i]['sorta'] != $ls) && (($ships[$i]['sorta'] == 0) || ($ships[$i]['sorta'] == 1) || ($ships[$i]['sorta'] == 2) || ($ships[$i]['sorta'] == 3) || ($ships[$i]['sorta'] == 4) || ($ships[$i]['sorta'] == 5))) {
			echo "<tr>
				...
				<td class=tdmainobg align=center><img src=" . $grafik . "/goods/50.gif alt='H�llenlevel anzahl/min/max'></td>
	...
	<table width=100% cellpadding=1 cellspacing=1 bgcolor=#262323>
	<tr>
		<td class=tdmain align=center colspan=6>H�llenmodule</td>
	</tr>
	<tr>
		<td class=tdmainobg width=30%><strong>Name</strong></td>
		<td class=tdmainobg width=6% align=center><strong>Lvl</strong></td>
		<td class=tdmainobg width=11% align=center><strong>H�lle</strong></td>
	...
	<tr>
		<td class=tdmainobg>Sympathie ben�tigt f�r Level " . $data['level'] . ": " . $data['symp'] . "</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class=tdmainobg width=120>Erd�hnlich</td>
	</tr>";
	...
	<tr>
		...
		<td class=tdmainobg width=120>W�stenplanet</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class=tdmainobg width=120>�dlandplanet</td>
	</tr>
	<tr>
	...
	echo "<tr><td colspan=4 class=tdmain align=center width=420><font color=darkgray><strong>Keine Daten verf�gbar</strong></font></td></tr>";
	echo "<tr>
	...
	echo "<tr><td class=tdmainobg>Atmosph�re: " . $data['atmos'] . "</td></tr>
			</table>
		</td>
	</tr>
	</table>";
	...
	echo "<table width=100% cellpadding=1 cellspacing=1 bgcolor=#262323>
	<tr>
		<td class=tdmain>/ <a href=?page=stats>Statistiken</a> / <strong>Waren�bersicht</strong></td>
	</tr>
	</table><br>
	...
	<br>&nbsp;<br>Vertrag von Ivor, mit Zus�tzen<br>reduzierte, vereinfachte Form<br>&nbsp;<br>
	...
	<tr>
		...
		<td class=tdmainobg>Die Handelsallianz ist zust�ndig f�r die Verwaltung, Entsendung und Startausstattung aller Kolonisten.</td>
	</tr>
	<tr>
		<td class=tdmainobg width=30>1.2</td>
		<td class=tdmainobg>Ihre Angebote (Warenb�rse, Uplink zu Datenbanken etc.) sind ein Service der Handelsallianz, �ber die sie frei entscheiden kann. Der Zugang zu diesen Angeboten ist kein Grundrecht und kann nach den W�nschen der Handelsallianz entzogen werden.</td>
	</tr>
	<tr>
		<td class=tdmainobg width=30>1.3</td>
		<td class=tdmainobg>Die Handelsallianz ist neutral. Sie behandelt alle unterzeichnenden M�chte als gleichwertig und bevorzugt weder eine Gro�macht, noch ist sie einer Gro�macht unterstellt.</td>
	</tr>
	</table>
	<br>
	<table width=100% bgcolor=#262323 cellspacing=1 cellpadding=1>
	...
	<tr>
		...
		<td class=tdmainobg>Sektor 75 ist Niemandsland. Keine Gro�macht und kein Verband von Siedlern hat das Recht, Raum innerhalb des Sektors zu annektieren oder f�r sich zu beansprochen.</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class=tdmainobg>Ausnahme: Der bereits vorhandene F�derationsraum am s�dlichen Ende des Sektors bleibt unangetastet. Kolonisation ist nicht gestattet.</td>
	</tr>
	<tr>
		<td class=tdmainobg width=30>2.4</td>
		<td class=tdmainobg>Es ist den Gro�m�chten sowie der Handelsallianz erlaubt, Anlagen in Sektor 75 zu errichten und den Zugang zu diesen zu Beschr�nken.</td>
	</tr>
	<tr>
		<td class=tdmainobg width=30>2.5</td>
		<td class=tdmainobg>Weitere M�chte k�nnen eine Erlaubnis bei den Gro�m�chten einholen, um ebenfalls Anlagen und/oder Kolonien errichten zu k�nnen.</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class=tdmainobg>Es gelten die Vertr�ge von Khitomer sowie das Friedensabkommen von 2378.</td>
	</tr>
	</table>
	<br>
	<table width=100% bgcolor=#262323 cellspacing=1 cellpadding=1>
	<tr>
		...
		<td class=tdmainobg>Gro�m�chte</td>
	</tr>
	<tr>
		<td class=tdmainobg width=30>3.1</td>
		<td class=tdmainobg>Gro�m�chte bezeichnet die Unterzeichner dieses Vertrages, namentlich und in ungeordneter Reihenfolge: Die Vereinte F�deration der Planeten, Das Romulanische Sternenimperium, Das Klingonische Imperium, Die Cardassianische Union, Die Breen Konf�deration, Die Ferengi Allianz.</td>
	</tr>
	<tr>
		<td class=tdmainobg width=30>3.2</td>
		<td class=tdmainobg>Die Gro�m�chte verpflichten sich, diesen Vertrag zu wahren und f�r seine Einhaltung zu sorgen.</td>
	</tr>
	<tr>
		<td class=tdmainobg width=30>3.3</td>
		<td class=tdmainobg>M�chte, deren Ziel es ist, den Vertrag von Ivor aufzul�sen, sind als Feind einzustufen.</td>
	</tr>
	</table>
	<br>
	<br>Diese Darstellung erhebt keinen Anspruch auf Vollst�ndigkeit oder Richtigkeit.";
	...
	<tr>
		...
		<td class=tdmainobg width=90%><font color=#0088FF><b>F�deration</b></font></td>
	</tr>
	</table>
	<table width=100% cellpadding=1 cellspacing=1 bgcolor=#262323 border=0>
	<tr>
		...
		<td class=tdmainobg align=center width=50%>Haupt-F�derationsbasis in Sektor 75</td>
	</tr>
	<tr>
		...
		<td class=tdmainobg align=center width=50%>Sternenbasis an der F�derationsgrenze</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class=tdmainobg align=center width=50%>Erholungs- und Vergn�gungskolonie</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class=tdmainobg width=30%>Au�enposten</td>
		<td class=tdmainobg align=center width=10%>175/114</td>
		<td class=tdmainobg align=center width=50%><font color=red>Warnung! Einflug gef�hrlich!</font></td>
	</tr>
	</table>
	<br>
	<table width=100% cellpadding=1 cellspacing=1 bgcolor=#262323>
	...
	echo "<tr><td class=tdmainobg align=center colspan=3>[<a href=static/leftbottom.php>Schlie�en</a>]</td></tr></table>";
}