...
<table bgcolor=#262323 cellspacing=1 cellpadding=1>
	<tr>
		<form action=main.php method=post>
			...
			<td class=tdmainobg>Spielername: <input class=text size=30 type=text name=username value="<?php echo $myUser->uuser ?>"></td>
	...
	<tr>
		<td class=tdmainobg colspan=2>ICQ-No: <input type=text name=icq size=10 class=text value='<?php echo $myUser->uicq ?>'></td>
	</tr>
	<tr>
		<td class=tdmainobg>Grafikpfad: <input class=text type=text size=40 name=new_grafik value='<?php echo $grafik ?>'></td>
		<td class=tdmainobg><input class=button type=button value='Standard' onClick="document.all.new_grafik.value = 'http://gfx.stuniverse.de'"> <a href=gfx/images.zip>Grafikpack downloaden</a></td>
	</tr>
	<tr>
		<td class=tdmainobg colspan=2>Beispiel: file:///Laufwerk|/Verzeichnis/stu</td>
	</tr>
	<tr>
		<td class=tdmainobg>KN-/Profil-Bild URL: <input class=text type=text size=40 name=new_picture value="<?php echo stripslashes($myUser->upicture) ?>"></td>
	...
	<tr>
		<td class=tdmainobg>Urlaubsmodus aktivieren: <input type="checkbox" name="avm" <?php if ($myUser->upvac == 0) echo " disabled=yes"; ?>></td>
		<td class=tdmainobg><a href=http://wiki.stuniverse.de/index.php/Urlaubsmodus target=_blank>Wiki-Artikel zum Urlaubsmodus</a></td>
	</tr>
	<tr>
		<td class=tdmainobg colspan=2>Du kannst den Urlaubsmodus in diesem Monat noch <?php echo $myUser->upvac ?> mal aktivieren</td>
	</tr>
	<tr>
...
<table width=700 cellpadding=1 cellspacing=1 bgcolor=#262323>
	<form action=main.php method=post>
		...
		<tr>
			<td class=tdmainobg>Hier k�nnt ihr einen kleinen RPG-Text �ber euch verfassen. Wer ihr seid, woher ihr kommt, etc</td>
		</tr>
		<tr>
