...
<head>
	...
	$npcmenu = isset($_GET['npcmenu']) ? $_GET['npcmenu'] : 0;
...
<body>
    ...
    &nbsp;<br />
    <input type=text size=3 class=text maxlength=3 /> | <input type=text size=3 class=text maxlength=3 />&nbsp;<a
        href=../main.php?page=hally&section=scl target=leftbottom><img src=http://gfx.stuniverse.de/buttons/classm.gif
            title="Kolonieliste" border=0></a>
</body>
