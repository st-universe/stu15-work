...
if (!$section || ($section == "main")) {
	...
	<tr>
		<td align=center class=tdmainobg><a href=index.php?page=lostpass&section=changepass>Passwort �ndern</a></td>
	</tr>
	</table>
	</form>";
	...
	<tr>
		<td colspan=2 align=center><input type=submit value=�ndern class=button></td>
	</tr>
	</table>
	</form>";
}
