...
function mkRSS()
{
   ...
   $lines = "20";              // Anzahl anzuzeigender Datens�tze
   ...
   while ($row = mysql_fetch_array($result)) {
      $titel = substr($row[$itemTitle], 0, 150);  //$row anpassen! auch in der n�chsten Zeile
      $text = substr($row[$itemText], 0, 500); //der Text darf h�chstens 500 Zeichen lang sein
      $itemLink = "...";   //dies ist ein Link, der DIREKT diesen Punkt auf der Homepage �ffnet.
